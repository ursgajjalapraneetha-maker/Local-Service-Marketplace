    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl lg:text-2xl font-heading font-bold text-secondary">Payments</h1>
        </div>
        <p className="text-sm text-gray-500 mt-0.5">Payment history and invoices</p>
      </div>
    </div>
  )
}
