...
const DUMMY_NOTIFICATIONS = [
  { id: 1, title: 'Booking Confirmed', message: 'Your cleaning service is confirmed for tomorrow.', time: '5 min ago', unread: true },
  { id: 2, title: 'Payment Successful', message: '₹2,499 paid for Home Deep Cleaning.', time: '2 hours ago', unread: true },
  { id: 3, title: 'Review Reminder', message: 'How was your AC repair service? Share your feedback.', time: '1 day ago', unread: false },
]
        ...
        {isOpen && (
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
              ...
              <button
                onClick={close}
                className="p-0.5 text-gray-400 hover:text-gray-600 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
            ...
            <div className="max-h-72 overflow-y-auto">
              {DUMMY_NOTIFICATIONS.map((n) => (
                <button
                  key={n.id}
                  className={`w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 ${
            ...
            <div className="px-4 py-2.5 border-t border-gray-100">
              <button className="text-xs font-medium text-primary hover:text-primary-dark transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30">
